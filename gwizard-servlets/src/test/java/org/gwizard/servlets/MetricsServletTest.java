...
public class MetricsServletTest extends AbstractServletTest {
    ...
    private final MetricsServletConfig config = MetricsServletConfig.builder().allowedOrigin("*").build();
    ...
    protected void setUp(ServletTester tester) {
        metricServlet = new MetricsServlet(registry, mapper, config, MetricFilter.ALL);
        ServletHolder holder = new ServletHolder(metricServlet);
        tester.addServlet(holder, "/metrics");
    }
